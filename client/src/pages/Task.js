        ...
        {selected === 0 ? (
          <>
            <div className="w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white shadow-md p-8 overflow-y-auto">
              ...
              <div className="w-full md:w-1/2 space-y-8">
                ...
                <div className="flex items-center gap-8 p-4 border-y border-gray-200">
                  <div className="space-x-2">
                    <span className="font-semibold">Attachements :</span>
                  ...
                  <div className="space-y-3">
                    {task?.team?.map((m, index) => (
                      ...
                      >
                        <div
                          className={
                            "w-10 h-10 rounded-full text-white flex items-center justify-center text-sm -mr-1 bg-teal-500"
                          }
                        >
                      ...
                      <div key={index} className="flex gap-3">
                        ...
                        <div className="space-y-1">
                          <div className="flex gap-2 items-center">
                            ...
                            <span className="px-2 py-0.5 text-center text-sm rounded-md bg-violet-100 text-violet-700 font-semibold">
                              {el?.tag}
                            </span>
                          </div>
              ...
              {/* RIGHT */}
              <div className="w-full md:w-1/2 space-y-8">
                <p className="text-lg font-semibold text-gray-600 test-sm">
                  DESCRIPTION
                </p>
                <textarea
                  value={description}
  ...
  return (
    <div className="w-full flex gap-10 2xl:gap-20 min-h-screen px-10 py-8 bg-white shadow rounded-md justify-between overflow-y-auto">
      ...
      <div className="w-full md:w-1/3">
        <h4 className="text-gray-600 font-semibold text-lg mb-10">
          ADD ACTIVITY
        </h4>
